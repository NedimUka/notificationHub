...
func (c *notificationClient) SendNotification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (*NotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/notification.Notification/SendNotification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Notification_SendNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/notification.Notification/SendNotification",
	}
...
var Notification_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protoModels/notification.proto",
}
